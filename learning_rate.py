...
def learning_rate():
    label_encoded_y = LabelEncoder().fit_transform(hoc_y)
    ...
    grid_result = grid_search.fit(hoc_X, label_encoded_y)
    ...
    usable = [learning_rate, n_estimators, scores]

    filename = 'usable.pickle'
    outfile = open(filename, 'wb')
    pickle.dump(usable, outfile)
    outfile.close()
